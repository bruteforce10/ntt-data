    ...
    items: [
      {
        ...
        title: "POC FUNDING",
        descriptionHtml:
          "Proof of Concept (POC) funding of up to USD <strong>$30,000</strong> to help turn ideas into reality.",
        image: {
