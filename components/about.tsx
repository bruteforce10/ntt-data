  ...
  return (
    <section id="about" className="relative overflow-hidden">
      <div className="relative min-h-[280px] sm:min-h-[560px] lg:min-h-[240px]">
        ...
        <div className="relative z-10 mx-auto flex min-h-[280px] max-w-[760px] flex-col items-center justify-center px-6 py-20 text-center sm:min-h-[560px] lg:min-h-[240px]">
